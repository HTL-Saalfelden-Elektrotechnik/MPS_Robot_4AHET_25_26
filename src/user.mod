MODULE user
    ...
    CONST robtarget slide_handling:=[[183.81,297.96,102.75],[0.591322,0.000208257,0.806436,0.000388234],[0,-2,1,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]];
    CONST robtarget slide_handling1:=[[183.80,297.95,238.63],[0.591304,0.00019878,0.806449,0.000365317],[0,-2,1,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]];
    ...
    CONST robtarget belt_sorting1:=[[408.70,430.84,263.43],[0.429055,0.0057989,0.903254,0.003164],[0,-1,0,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]];
    CONST robtarget belt_sorting2:=[[169.65,430.84,263.42],[0.429054,0.00576739,0.903255,0.0031659],[0,-1,1,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]];
	...
	PROC takeTesting()
		...
		MoveL [[73.33,-261.25,677.51],[0.470972,-0.0386563,0.881161,-0.0157133],[-1,0,-1,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]], v1000, z15, tool0;
		...
		MoveL [[193.01,-444.74,575.52],[0.6,-0.0212249,0.799509,0.0182975],[-1,0,-1,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]], v1000, z150, tool0;
		...
		MoveJ belt_sorting2, v1000, z150, tool0;
		MoveL belt_sorting1, v1000, z0, tool0;
		MoveL belt_sorting, v1000, fine, tool0;
        ...
        MoveL [[176.66,411.65,264.66],[0.455621,0.0029393,0.889088,0.0438445],[0,-1,1,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]], v1000, z100, tool0;
    ...
    PROC take_handling()
        ! Move to slide
        MoveJ slide_handling1, v2500, fine, tool0;
        MoveJ slide_handling, v1000, fine, tool0;
